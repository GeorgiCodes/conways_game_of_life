    ...
    seed: function(seedType, cells) {
      ...
      switch (seedType) {
        case "random":
          ...
          break;
        case "glider":
          this.cells.set("1/2", true);
          this.cells.set("1/4", true);
          this.cells.set("2/4", true);
          this.cells.set("2/5", true);
          this.cells.set("0/5", true);
          break;
        case "oscillator":
          this.cells.set("1/0", true);
          this.cells.set("1/1", true);
          this.cells.set("1/2", true);
          break;
      }
      // TODO: refactor
